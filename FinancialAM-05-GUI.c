...
#include <SDL2/SDL.h>           // SDL2 library to support more (if needed)
...
/*
void StartApplication(void) {
    system("gcc `pkg-config --cflags sdl2 gtk4` FinancialAM-05-GUI.c -o FinancialAM-05-GUI `pkg-config --libs sdl2 gtk4`")
}
*/
